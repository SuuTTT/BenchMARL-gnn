...
from onpolicy.envs.gym_pybullet_drones.gym_pybullet_drones.envs.multi_agent_rl.NavAviary import NavAviary
...
def parse_args(args, parser):
    parser.add_argument('--scenario_name', type=str,
                        default='2d-navigation', help="Which scenario to run on")
    ...
    parser.add_argument('--exe_num_mini_batch', type=int, default=2, help="local_num_step")
    parser.add_argument('--ctl_num_mini_batch', type=int, default=2, help="local_num_step")
...
def main(args):
    ...
    if all_args.share_policy:
        if all_args.use_macro:
            from onpolicy.runner.shared.drone_hrunner import DroneHRunner as Runner
        else:
